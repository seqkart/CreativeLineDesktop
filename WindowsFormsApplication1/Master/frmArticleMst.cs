    ...
    public partial class frmArticleMst : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void SetMyControls()
        {
            try
            {
                ...
                ProjectFunctions.TextBoxVisualize(GroupBox15);
                ...
                txtMPPer.Properties.MaxLength = 100;
                ...
                txtWPPer.Properties.MaxLength = 100;
            ...
            try
            {
                ...
                if (s1 == "Edit")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        txtMPPer.Text = ds.Tables[0].Rows[0]["ARTMPPRCN"].ToString();
                        txtMRP.Text = ds.Tables[0].Rows[0]["ARTMRP"].ToString();
                        txtPurPrice.Text = ds.Tables[0].Rows[0]["ARTPURPRICE"].ToString();
                        txtWPPer.Text = ds.Tables[0].Rows[0]["ARTWPPRCN"].ToString();
        ...
        private bool ValidateData()
        {
            try
            {
                ...
                if (txtMPPer.Text.Trim().Length == 0)
                {
                    txtMPPer.Text = "0";
                }
                ...
                if (txtWPPer.Text.Trim().Length == 0)
                {
                    txtWPPer.Text = "0";
                }
                ...
                if (ValidateData())
                {
                    using (var sqlcon = new SqlConnection(ProjectFunctions.GetConnection()))
                    {
                        ...
                        try
                        {
                            ...
                            sqlcom.Parameters.AddWithValue("@ARTWPPRCN", Convert.ToDecimal(txtWPPer.Text));
                            ...
                            sqlcom.Parameters.AddWithValue("@ARTMPPRCN", Convert.ToDecimal(txtMPPer.Text));
